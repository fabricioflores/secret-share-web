...
class SecretsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create secret" do
    assert_difference('Secret.count') do
      post secrets_url, params: { secret: { available: @secret.available, description: @secret.description, needed: @secret.needed, splits: @secret.splits } }
    end
  ...
  test "should update secret" do
    patch secret_url(@secret), params: { secret: { available: @secret.available, description: @secret.description, needed: @secret.needed, splits: @secret.splits } }
